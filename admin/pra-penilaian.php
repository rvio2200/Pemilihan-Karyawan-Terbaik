...
<body>
    ...
    <form method="POST" action="halaman_penilaian.php">
        ...
        <select name="periode_id">
            ...
            $sql = mysqli_query($conn, "SELECT * FROM tbl_subkriteria WHERE id_kriteria='$_GET[id_kriteria]'");"SELECT id_periode, nama_periode FROM tbl_periode";
            $result = $koneksi->query($sql);

            // Tampilkan daftar periode sebagai pilihan
