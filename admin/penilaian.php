            ...
            <tbody>
                <?php
                    ...
                    while ($result = mysqli_fetch_array($query)) {
                        ...
                        $query1 = mysqli_query($conn, "SELECT a.nama_subkriteria as nama_sub FROM tbl_subkriteria a, tbl_nilai b WHERE b.id_alternatif='".$kode."' AND a.id_subkriteria=b.id_subkriteria ORDER BY b.id_kriteria");
                ...
                ?>
                        <td class="text-center">
                            <a href="penilaian-aksi.php?id_alternatif=<?php echo $result['id_alternatif'] ?>&aksi=ubah" class="btn btn-info btn-sm" style="padding: 0.2rem 0.5rem;"><span class="fa fa-pencil fa-sm"></span></a>
                            <a href="penilaian-proses.php?id_alternatif=<?php echo $result['id_alternatif'] ?>&proses=proses-hapus" class="btn btn-danger btn-sm" style="padding: 0.2rem 0.5rem;"><span class="fa fa-trash fa-sm"></span></a>
                        </td>
