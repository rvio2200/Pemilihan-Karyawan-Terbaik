...
<body>
    ...
    <h2><b>DATA SUBKRITERIA/ <a href="kriteria.php"><?php echo $result1['nama_kriteria']; ?></a></b></h2>

    <a href="subkriteria-aksi.php?id_kriteria=<?php echo $_GET['id_kriteria'] ?>&aksi=tambah" class="btn btn-success btn-sm"><span class="fa fa-plus"></span>&emsp;Tambah Data </a>
    <br><br>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-left"><?php echo $result['nama_subkriteria']; ?></td>
                        <td class="text-center"><?php echo $result['nilai_subkriteria']; ?></td>

                       
                        <td class="text-center">
                            <a href="subkriteria-aksi.php?id_kriteria=<?php echo $result['id_kriteria'] ?>&id_subkriteria=<?php echo $result['id_subkriteria'] ?>&aksi=ubah" class="btn btn-info"><span class="fa fa-pencil"></span></a>
                            <a href="subkriteria-proses.php?id_kriteria=<?php echo $result['id_kriteria'] ?>&id_subkriteria=<?php echo $result['id_subkriteria'] ?>&proses=proses-hapus" class="btn btn-danger"><span class="fa fa-trash"></span></a>
                        </td>
                    </tr>
                <?php
                    }
