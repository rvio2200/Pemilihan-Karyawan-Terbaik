...
<body>
    ...
    <div class="panel panel-container" style="width: 50%; margin: 0 auto; padding: 20px; box-shadow: 2px 2px 5px #888888;">
        <h2><b>DATA ALTERNATIF</b></h2>
        <a href="alternatif-aksi.php?aksi=tambah" class="btn btn-success btn-sm">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="alternatif-aksi.php?id_alternatif=<?php echo $result['id_alternatif'] ?>&aksi=ubah" class="btn btn-info btn-sm" style="padding: 0.2rem 0.5rem;">
                                    <span class="fa fa-pencil fa-sm"></span>
                                </a>
                                <a href="alternatif-proses.php?id_alternatif=<?php echo $result['id_alternatif'] ?>&proses=proses-hapus" class="btn btn-danger btn-sm" style="padding: 0.2rem 0.5rem;">
